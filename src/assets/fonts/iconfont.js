(function (window) {
  ...
  }; var before = function (el, target) { target.parentNode.insertBefore(el, target) }; var prepend = function (el, target) { if (target.firstChild) { before(el, target.firstChild) } else { target.appendChild(el) } }
  ...
  function appendSvg () {
    ...
    svgSprite = null
    svg = div.getElementsByTagName('svg')[0]; if (svg) {
